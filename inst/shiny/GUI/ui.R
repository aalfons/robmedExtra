  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          # this again has two tabs: one for information on the selected model,
          # and one for a description of the implemented mediation models
          tabsetPanel(
            ...
            tabPanel(
              "Description of mediation models",
            ...
            id = "model_main_panel",
            selected = "Description of mediation models"
    ...
    tabPanel(
      ...
      sidebarLayout(
        # input panel on left hand side
        sidebarPanel(
          # buttons to preview/downlaod files and inputs for table options
          uiOutput("button_preview"),
          uiOutput("select_file_type_diagram"),
        ...
        mainPanel(
          ...
          tabsetPanel(
            ...
            tabPanel(
              "Model diagram",
              uiOutput("diagram_preview_header"),
              plotOutput("diagram_preview")
            ),

            # preview of diagnostic plot
            tabPanel(
              "Diagnostic plot",
