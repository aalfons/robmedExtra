...
#' @docType package
#'
#' @title \packageTitle{robmedExtra}
#'
#' @description \packageDescription{robmedExtra}
#'
#' @details
#' The DESCRIPTION file:
#' \packageDESCRIPTION{robmedExtra}
#' \packageIndices{robmedExtra}
#'
#' @references
...
#'
#' @author
#' \packageAuthor{robmedExtra}
#'
#' Maintainer: \packageMaintainer{robmedExtra}
#'
#' @keywords package
